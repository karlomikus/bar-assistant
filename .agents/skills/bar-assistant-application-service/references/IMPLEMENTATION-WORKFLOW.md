...
## Controller Pattern by Operation
...
- load legacy model for policy context if needed
- validate request
- authorize `edit`
- build update DTO
- call service
...
- update existing row
- replace or sync nested relations as required by the aggregate
...
- load aggregate
- throw on missing entity
- perform any cleanup or hierarchy changes
