...
#[OAT\Schema(
    ...
    properties: [
        new OAT\Property(property: 'favorite_tags', type: 'array', items: new OAT\Items(type: 'object', required: ['tag_name', 'weight'], properties: [
        ...
        new OAT\Property(property: 'favorite_ingredients', type: 'array', items: new OAT\Items(type: 'object', required: ['ingredientId', 'weight'], properties: [
            new OAT\Property(property: 'ingredient_id', type: 'integer', example: 3),
            new OAT\Property(property: 'weight', type: 'number', format: 'float', example: 0.75),
        ])),
...
class UserTasteProfileResource extends JsonResource
{
    ...
    {
        return [
            'favorite_tags' => array_map(fn ($tag) => ['name' => $tag->tagName, 'weight' => $tag->weight], $this->favoriteTags),
            'favorite_ingredients' => array_map(fn ($tag) => ['ingredient_id' => $tag['ingredientId'], 'weight' => $tag['weight']], $this->favoriteIngredients),
