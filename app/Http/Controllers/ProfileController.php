...
{
    #[OAT\Get(path: '/profile', tags: ['Profile'], operationId: 'showProfile', summary: 'Show profile')]
    ...
    #[OAT\Post(path: '/profile', tags: ['Profile'], operationId: 'updateProfile', summary: 'Update profile', requestBody: new OAT\RequestBody(
        required: true,
        content: [
