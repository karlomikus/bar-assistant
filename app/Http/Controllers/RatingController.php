...
{
    #[OAT\Post(path: '/cocktails/{id}/ratings', tags: ['Ratings'], operationId: 'rateCocktail', summary: 'Rate a cocktail', parameters: [
    ...
    #[OAT\Delete(path: '/cocktails/{id}/ratings', tags: ['Ratings'], operationId: 'deleteRating', summary: 'Delete current user\'s cocktail rating', parameters: [
        new BAO\Parameters\DatabaseIdParameter(),
    ])]
    #[OAT\Response(response: 204, description: 'Successful response')]
    #[BAO\NotAuthorizedResponse]
