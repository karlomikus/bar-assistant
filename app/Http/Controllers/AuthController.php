...
{
    #[OAT\Post(path: '/auth/login', tags: ['Authentication'], operationId: 'authenticate', summary: 'Authenticate user and get a token', requestBody: new OAT\RequestBody(
        required: true,
        content: [
    ...
    #[OAT\Post(path: '/auth/logout', tags: ['Authentication'], operationId: 'logout', summary: 'Logout currently authenticated user')]
    ...
    #[OAT\Post(path: '/auth/register', tags: ['Authentication'], operationId: 'register', summary: 'Register a new user', requestBody: new OAT\RequestBody(
        required: true,
        content: [
    ...
    #[OAT\Post(path: '/auth/forgot-password', tags: ['Authentication'], operationId: 'passwordForgot', summary: 'Request a new user password', requestBody: new OAT\RequestBody(
        required: true,
        content: [
    ...
    #[OAT\Post(path: '/auth/reset-password', tags: ['Authentication'], operationId: 'passwordReset', summary: 'Reset user password', requestBody: new OAT\RequestBody(
        required: true,
        content: [
            new OAT\JsonContent(type: 'object', properties: [
    ...
    #[OAT\Get(path: '/auth/verify/{id}/{hash}', tags: ['Authentication'], operationId: 'confirmAccount', summary: 'Confirm user account', parameters: [
