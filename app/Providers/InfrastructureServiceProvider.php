...
use Kami\Cocktail\Infrastructure\EloquentReviewRepository;
...
use Kami\Cocktail\Infrastructure\EloquentIngredientReviewRepository;
...
class InfrastructureServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(IngredientReviewRepository::class, EloquentIngredientReviewRepository::class);
